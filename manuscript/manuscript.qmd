...
## Lactate transport inhibition signals through histone lactylation
...
## Lactate transport inhibition / redox stress section

We next examined whether MCT inhibition affects TGFβ-dependent signaling pathways. TGFβ activates both SMAD and non-SMAD signaling pathways. We found no impact of MCT inhibition on decreasing Smad3 or ERK phosphorylation in LFs 48 h following TGFβ stimulation (**Figure 5**). 

Hypoxia-inducible factor 1α (HIF-1α) is activated in lung fibroblasts following TGFβ and is required for myofibroblast differentiation and experimental pulmonary fibrosis partly through activation of glycolysis [@goodwin2018]. We found maximal HIF-1α stabilization 6 h following TGFβ treatment. At this time point, MCT inhibition did not decrease HIF-1α (**Figure 5E-F**), rather, HIF-1α protein levels were increased with combined MCT1 and MCT4 inhibition. 
